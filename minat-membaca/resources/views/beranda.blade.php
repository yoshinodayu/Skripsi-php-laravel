    ...
    <div class="col-sm-8 float-left">
        ...
        <div class="pr-5 pt-3">
            <ul>
                ...
                <li>
                    <p class="font-weight-bold">Penangkal Informasi Bohong</p>
                    <p class="text-dark" style="text-align:justify">
                ...
                <li>
                    <p class="font-weight-bold">Sumber Inspirasi</p>
                    <p class="text-dark" style="text-align:justify">
                ...
                <li>
                    <p class="font-weight-bold">Berita Memperlambat Penuaan</p>
                    <p class="text-dark" style="text-align:justify">
                ...
                <li>
                    <p class="font-weight-bold">Meningkatkan Kreativitas</p>
                    <p class="text-dark" style="text-align:justify">
